...
if (!function_exists("render_faq")) {
	function render_faq($info) {
		...
		echo "<span class='strong'>If you willing to ask our administration a question, there is a few ways you can do it.
		You can use Contact Us page, post your question in Help section of our forum, PM Administrator using messaging service
		or simply email us at admin@easypcfix.org.</span><br><br>
		";
		echo "<!--pre_faq_idx-->\n";
