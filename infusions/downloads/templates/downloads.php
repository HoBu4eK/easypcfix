...
if (!function_exists('display_download_menu')) {
	function display_download_menu($info) {
		...
		<tr>
		<td><div class='text-bigger strong text-dark m-b-20 m-t-20'><i class='fa fa-home m-r-10'></i><a style='color:#333;' title='".$locale['download_1001']."' href='".DOWNLOADS."downloads.php'>".$locale['download_1001']."</a></div></td>
		<td><div class='text-bigger strong text-dark m-b-20 m-t-20'><i class='fa fa-list m-r-10'></i> ".$locale['download_1003']."</div></td>
		<td><div class='text-bigger strong text-dark m-b-20 m-t-20'><i class='fa fa-users m-r-10'></i> ".$locale['download_1004']."</div></td>
		</tr>
		<tr>
		<td valign='top'><ul class='m-b-40'>";
